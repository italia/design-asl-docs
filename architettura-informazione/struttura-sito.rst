...
-	**ASL comunica** (etichetta che può essere cambiato in base alla tipologia di ente, seguendo la logica "{sigla_ente} comunica", ad esempio "ASP comunica" o "USL comunica"), con tutti i contenuti per tenere gli utenti aggiornati con le ultime novità;
